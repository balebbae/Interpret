...
export function SimpleTree() {
  ...
  const createTree = (width: number, height: number): Tree => {
    ...
    const x = width / 2
    const y = height * 0.5 // Centered vertically so shadow extends off-screen
  ...
  return (
    <div className="w-full h-full overflow-hidden relative">
      ...
      <div className="absolute bottom-2 right-4 text-xs text-black/20 dark:text-white/20 font-light">
